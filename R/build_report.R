...
build_report <- function(spec, mets, dict, validation, ms_results = NULL,
  ...
  md <- c(md, "## 9. Methods", "",
    ...
    "Molecular formulas for nucleobases, sugars, linkages, and conjugates were defined based on standard atomic compositions and validated against the ION337 reference workbook to <1 ppm mass accuracy.", "",
